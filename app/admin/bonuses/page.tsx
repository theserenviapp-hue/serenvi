      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card title="Fast Track Bonus">
            <p className="text-gray-600 mb-4">Distribute 40% of daily sales to eligible members</p>
            <Button onClick={() => handleDistribute('FAST_TRACK')} disabled={loading} className="w-full">Distribute Now</Button>
          </Card>
          <Card title="Talent Dividend">
            <p className="text-gray-600 mb-4">Distribute 30% of team sales proportionally</p>
            <Button onClick={() => handleDistribute('TALENT_DIVIDEND')} disabled={loading} className="w-full">Distribute Now</Button>
          </Card>
        </div>
